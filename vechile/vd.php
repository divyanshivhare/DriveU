...
<?php
    $con=new mysqli('localhost','root','','veichle')or die("Could not connect to Mysql" .mysqli_error($con));

    $rg_no=$_POST['rg_no'];
    $name=$_POST['name'];
    $vname=$_POST['vname'];
    $rg_year=$_POST['rg_year'];
    $fule=$_POST['fule'];

    $sql="insert into vehicle set rg_no='$rg_no',name='$name',vname='$vname',rg_year='$rg_year',fule='$fule'";
